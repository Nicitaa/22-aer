  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-full bg-secondary py-6 flex flex-col gap-6">
        <div
          className="flex flex-row gap-6 overflow-hidden px-3"
        ...
        <h1 className="font-primary text-medium font-bold px-6">
          Want become our partner? -&nbsp;
          <Link
            className="font-primary text-medium font-bold text-cta"
